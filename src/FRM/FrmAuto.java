...
//    }
 /** Este método se llama desde dentro del constructor para inicializar el formulario.
    ...
    private void initComponents() {
        ...
        btnGuardar.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                btnGuardarItemStateChanged(evt);
            }
        });
...
//
    ...
    private void btnGuardarItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_btnGuardarItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_btnGuardarItemStateChanged
